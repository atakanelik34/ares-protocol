...
| ECO-06 | Governance capture through concentrated voting power | P3-P4 | Launch-critical risk if token distribution and quorum settings permit capture; low-turnout passing threshold remains material under current settings | Governor/timelock model exists; governance threshold and capture-cost artifacts now quantify quorum concentration and zero-threshold proposal spam; launch acceptance still not complete | Blocked |
