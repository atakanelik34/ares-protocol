...
4. Demo scenario:
   ...
   - 500 action scores recorded
   - 20 disputes total (18 finalized + 2 pending) with ARI correction checks
...
4. Day 6: seed deterministic demo data (40 agents / 500 actions / 20 disputes).
